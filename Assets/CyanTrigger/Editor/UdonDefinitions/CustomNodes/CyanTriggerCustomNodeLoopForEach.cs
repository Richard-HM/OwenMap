...
namespace Cyan.CT.Editor
{
        ...
        ICyanTriggerCustomNodeCustomVariableInitialization
    {
        ...
        public static Type DataListType;
        public static Type DataDictionaryType;
        ...
        public override void AddActionToProgram(CyanTriggerCompileState compileState)
        {
            ...
            // This is risky, but using it to prevent compile errors
            // TODO remove once DataDictionary and DataLists are more widely used.
            if (DataListType == null)
            {
                CyanTriggerNodeDefinitionManager.Instance.TryGetTypeFromFriendlyName("DataList", out DataListType);
            }
            if (DataDictionaryType == null)
            {
                CyanTriggerNodeDefinitionManager.Instance.TryGetTypeFromFriendlyName("DataDictionary", out DataDictionaryType);
            }
